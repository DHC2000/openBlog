<div class="modalEdit fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
            ...
            <div class="card">
                <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="" class="form-control" placeholder="Titulo" aria-describedby="helpId" value="{{ isset($et->title)?$et->title:'' }}">
                        </div>
                        <br>
                        <div class="mb-3">
